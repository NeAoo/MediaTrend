...
# Repository: https://internal.local/TrendCrawlerRuntime/blob/main/tools/async_file_writer.py
...
class AsyncFileWriter:
    ...
    def _get_file_path(self, file_type: str, item_type: str) -> str:
        ...
        # Generate filename with full timestamp to create new file each run
        timestamp = utils.get_current_time().replace(':', '-').replace(' ', '_')
