...
# Repository: https://internal.local/TrendCrawlerRuntime/blob/main/config/db_config.py
...
MYSQL_DB_NAME = os.getenv("MYSQL_DB_NAME", "trend_crawler_runtime")
...
MONGODB_DB_NAME = os.getenv("MONGODB_DB_NAME", "trend_crawler_runtime")
...
POSTGRES_DB_NAME = os.getenv("POSTGRES_DB_NAME", "trend_crawler_runtime")
